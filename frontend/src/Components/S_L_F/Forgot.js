...
async function sendEmail(event){
   ...
   axios.post("http://localhost:8000/forgot",jsonEmail).then((response)=>{
...
const NewPassSendServer={
 ...
 axios.post(`http://localhost:8000/forgot/${Server_data.id}`,NewPassSendServer).then(async(response)=>{
